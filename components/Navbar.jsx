    ...
    <>
      ...
      >
        <div className="max-w-[800px] mx-auto px-4 md:px-0 py-4 flex items-center justify-between">
          ...
          {/* Mobile menu button */}
          <button
            className="md:hidden p-2 -mr-2 text-[#444] flex flex-col justify-center items-center w-10 h-10 gap-1.5 relative z-[80]"
      ...
      {/* Mobile menu backdrop — outside nav to avoid stacking context */}
      <div
