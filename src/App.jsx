	...
	const workExperience = [
		{
			...
			highlights: [
				...
				"Built a semantic search system that uses Azure Cognitive Search, LangChain, and LangGraph to quickly and accurately find information within thousands of internal company documents.",
				...
				"Built an AI-powered internal chatbot with deep research, combining semantic search with internet queries to facilitate access to knowledge.",
			],
			technologies: [
				"Python",
				"LDA",
