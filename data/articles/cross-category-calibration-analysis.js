const article = {
  ...
  sections: [
    {
      paragraphs: [
        "Prediction markets promise a simple bargain: prices should equal probabilities (Wolfers & Zitzewitz, 2006). A contract trading at 70 cents should resolve YES about 70% of the time. When that relationship breaks, the gap between price and reality is either a trading opportunity or evidence of some deeper structural feature in how the market is pricing uncertainty.",
        "Recent work by Bürgi, Deng, and Whelan (2026) provides the first systematic exchange-wide analysis of Kalshi pricing and documents a favorite–longshot bias across contract types. This article narrows the scope and goes deeper. Instead of looking at the exchange in the aggregate, I focus on one contract family — mention markets — and examine how calibration varies across categories, across time horizons, and across simple trading rules.",
        "The dataset covers 18,948 resolved mention contracts across 126 distinct series spanning six categories: Politicians, Sports, Earnings, Entertainment, Finance, and Media/News. Using volume-weighted average prices (VWAPs) measured at several horizons before the last trade, I test how closely prices track realized outcomes, how quickly markets converge toward fair probabilities, and whether the remaining errors survive Kalshi's fee schedule well enough to matter in practice.",
      ],
    },
    {
      heading: "The Dataset",
    ...
    },
    {
      ...
      bullets: [
        "In-sample only. All results are computed on the full dataset without train/test splits, so the patterns may not persist out of sample.",
        ...
        "Market evolution. These markets are still relatively new, and calibration errors may continue to shrink as participants learn and liquidity deepens.",
        "Survivorship bias. Only resolved contracts with recorded trades are included; delisted, cancelled, or inactive markets are excluded.",
        "Maker fee advantage not modeled. Because resting orders can reduce or avoid taker fees under Kalshi's current schedule, a liquidity-provision strategy could improve on the taker-only results reported here.",
      ],
    },
    {
      heading: "Conclusion",
      paragraphs: [
        "Kalshi's mention markets exhibit systematic miscalibration that varies meaningfully by category. The dominant pattern is a longshot bias: low-probability contracts overestimate the likelihood of a mention, creating persistent value on the NO side. That bias survives after accounting for Kalshi's taker fee schedule, which conveniently charges less at the probability extremes where the mispricing is largest.",
        "The fact that Politicians — the highest-volume category — is also the best calibrated suggests that liquidity depth and participation contribute materially to price quality. That fits the broader evidence that thin markets and shallow participation undermine prediction-market forecasts (Wolfers & Zitzewitz, 2004; Arrow et al., 2008), and it also lines up with Bürgi, Deng, and Whelan's (2026) finding that Kalshi's broader pricing bias has diminished as volume has grown. By contrast, smaller and more structurally ambiguous categories such as Entertainment and Finance show larger deviations from fair pricing.",
        "Whether these patterns amount to durable alpha or mostly reflect in-sample measurement remains an open question. But the descriptive result is clear enough: mention markets do converge, they converge at different speeds depending on category, and some parts of that convergence process still leave a tradable amount of error on the table.",
      ],
    },
  ],
  citations: [
